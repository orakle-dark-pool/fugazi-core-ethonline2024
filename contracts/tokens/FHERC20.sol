...
/// Modified version of FHERC20 written by Fhenix team.
/// Ours do not return 0 even if owner or spender is trying to transfer token
/// more than they can--we adjust the amount into maximally possible one and
/// finish the task.
