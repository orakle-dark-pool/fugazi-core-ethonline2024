...
export interface FugaziCoreInterface extends Interface {
...
export interface FugaziCore extends BaseContract {
  connect(runner?: ContractRunner | null): FugaziCore;
  waitForDeployment(): Promise<this>;

  interface: FugaziCoreInterface;
